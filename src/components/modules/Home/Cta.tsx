    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-sm leading-relaxed text-slate-400 sm:text-base">
          Manage invoices, clients, payments, and business insights from one
          modern workspace built for freelancers and small businesses.
        </p>

        {/* TRUST */}
        <div className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-sm text-slate-400">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Link href="/demo/dashboard" scroll={false}>
            <Button
              variant="outline"
              className="h-12 w-full rounded-2xl border border-white/10 bg-white/3 px-7 text-sm font-medium text-slate-300 transition-all duration-300 hover:border-white/20 hover:bg-white/5 hover:text-white sm:w-auto"
            >
              Explore Demo
            </Button>
          </Link>

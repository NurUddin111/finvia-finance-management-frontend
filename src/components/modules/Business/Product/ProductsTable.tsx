    ...
    return (
      <div className="flex flex-col items-center justify-center gap-4 rounded-3xl border border-white/10 bg-linear-to-b from-[#0B1120] to-[#050816] px-6 py-14 text-center sm:py-16">
        <div className="flex h-14 w-14 items-center justify-center rounded-3xl border border-white/10 bg-white/3 sm:h-16 sm:w-16">
          <PackageOpen size={24} className="text-slate-500 sm:size-6.5" />
        </div>
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <div className="flex items-center gap-3">
                  <div className="flex h-9 w-9 items-center justify-center rounded-2xl border border-blue-500/20 bg-blue-500/10 sm:h-10 sm:w-10">
        ...
        <table className="min-w-262.5 w-full border-collapse">
          <thead>
            <tr className="border-b border-white/6 bg-white/2">
              <th className="w-[30%] px-3 py-4 text-left text-[10px] font-medium uppercase tracking-[0.14em] text-slate-500 lg:px-6 lg:text-[11px] lg:tracking-[0.18em]">
                Product
              </th>

              <th className="w-[20%] px-3 py-4 text-right text-[10px] font-medium uppercase tracking-[0.14em] text-slate-500 lg:px-6 lg:text-[11px] lg:tracking-[0.18em]">
                Revenue
              </th>

              <th className="w-[18%] px-3 py-4 text-center text-[10px] font-medium uppercase tracking-[0.14em] text-slate-500 lg:px-6 lg:text-[11px] lg:tracking-[0.18em]">
                Sold
              </th>
              ...
              <th className="w-[14%] px-3 py-4 text-right text-[10px] font-medium uppercase tracking-[0.14em] text-slate-500 lg:px-6 lg:text-[11px] lg:tracking-[0.18em]">
                Actions
              </th>
            </tr>
          </thead>

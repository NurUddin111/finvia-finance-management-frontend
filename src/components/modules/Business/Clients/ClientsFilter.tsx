  ...
  return (
    <div className="flex flex-col gap-2.5 mb-4 md:flex-row md:items-center">
      ...
      <div className="flex items-center gap-2.5">
        <select className="flex-1 md:flex-none border border-white/8 rounded-[9px] px-3 py-2 text-[13px] text-white/60 outline-none cursor-pointer focus:border-indigo-500/40 transition-colors">

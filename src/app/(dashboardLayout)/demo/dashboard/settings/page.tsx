          ...
          {settingsItems.map((item) => {
            ...
            return (
              <Link
                ...
                className="group flex items-center justify-between rounded-3xl border border-white/10 bg-linear-to-b from-[#0B1120] to-[#050816] p-4 transition-all duration-300 hover:border-white/15 hover:bg-white/2"
              >
                <div className="flex items-center gap-3">
                  <div

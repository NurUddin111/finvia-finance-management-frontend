...
export default function OnboardingPage() {
  ...
  return (
    <>
      ...
      <main className="relative min-h-[calc(100vh-72px)] overflow-hidden bg-[#050816] px-4 py-10">
        {/* BACKGROUND GLOW */}
        ...
        <div className="relative mx-auto flex min-h-[calc(100vh-120px)] w-full max-w-6xl items-center">
          <div className="grid w-full gap-10 lg:grid-cols-2 lg:items-center">
            ...
            <div className="relative">
              <div className="rounded-4xl border border-white/10 bg-linear-to-b from-[#0B1120] to-[#050816] p-6 shadow-[0_0_80px_rgba(0,0,0,0.45)]">
                {/* TOP */}
                ...
                <div className="space-y-4">
                  {features.map((feature) => {
                    ...
                    return (
                      <div
                        key={feature.title}
                        className="group flex items-start gap-4 rounded-2xl border border-white/8 bg-white/2 p-4 transition-all duration-300 hover:border-blue-500/15 hover:bg-blue-500/3"
                      >
                ...
                {/* FOOTER */}
                <div className="mt-8 rounded-2xl border border-violet-500/15 bg-violet-500/5 p-4">
